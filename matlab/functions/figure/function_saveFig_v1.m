...
%Author: Damián Dellavale.
%Date: 15/09/2015

%Description:
% In this script we save Matlab figures.
...
%Ref: http://www.dsprelated.com/showcode/223.php

function function_saveFig_v1(h, name, format)
%==========================================================================
% Usage: function_saveFig(H, NAME, FORMAT);
%
